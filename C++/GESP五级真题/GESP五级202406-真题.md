---
title: "【GESP】C++等级考试5级 2024年06月 真题"
date: 2024-06-22 10:00:00 +0800
math: true
---
...
### 编程题 1【[黑白格](https://fslong.iok.la/problem/4463)】(25分)
...
**样例解释：**
对于样例1，假设 (r, c) 代表第 r 行第 c 列，至少包含 5 个黑色格子的最小子矩形的四个顶点为 (2, 2)，(2, 5)，(4, 2)，(4, 5)，共包含 6 个格子。
...
### 编程题 2【[小杨的幸运数字](https://fslong.iok.la/problem/4464)】(25分)
小杨认为他的幸运数字应该恰好有两种不同的质因子，例如，12 的质因子有 2, 3，恰好为两种不同的质因子，因此 12 是幸运数字，而 30 的质因子有 2, 3, 5，不符合要求，不为幸运数字。
...
**数据范围：**
对于全部数据，保证有 1 ≤ N ≤ 10^5，每个正整数 x 满足 1 ≤ x ≤ 10^6。
